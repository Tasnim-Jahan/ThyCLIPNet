...
def aspp_block(inputs, num_filters=256):
    ...
    conv3_4 = Conv2D(num_filters, (3, 3), dilation_rate=18, padding="same", activation="relu")(inputs)

    avg_pool = GlobalMaxPooling2D()(inputs)
    ...
    output = Concatenate()([conv1, conv3_1, conv3_2, conv3_3, conv3_4, avg_pool])
